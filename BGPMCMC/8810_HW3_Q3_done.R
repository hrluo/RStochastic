...
Len<-dim(design.all)[1];
rownames(design.all)<-seq(1:Len);

l1=list(m1=outer(design.all[,1],design.all[,1],"-"),m2=outer(design.all[,2],design.all[,2],"-"))
l.v=list(l1=l1)
fitp=predict(l.v,fit2,eps.yy=1e-4)
